...
@Serializable
data class ScheduleRankingArguments(val creditValue: Double, val adjacentValue: Double)
...
class ScheduleRankingPage : Page() {
    ...
    fun getRanking(): ScheduleRankingArguments {
        return ScheduleRankingArguments(creditValue.value, adjacentValue.value)
    }
